...
class VLANStarTopo( Topo ):
    ...
    def build( self, k=3, n=3, vlanBase=100 ):
...
def exampleCustomTags():
    ...
    net = Mininet( topo=VLANStarTopo(),controller=None )
    net.addController('floodlightController', controller=RemoteController, ip="192.168.1.100", port=6653)
    net.start()
    CLI( net )
    net.stop()
